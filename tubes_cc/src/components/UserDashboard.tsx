            ...
            <div className="space-y-6 relative max-w-4xl">
              <div>
                <h2 className="text-3xl font-black text-white">
                  My <span className="bg-gradient-to-r from-[#00f0ff] to-blue-400 bg-clip-text text-transparent">Overview</span>
                </h2>
                <p className="text-sm text-slate-500 mt-1">
                  Track your personal deliverables and performance statistics.
                </p>
              </div>
                ...
                <div className="flex flex-col items-center justify-center bg-[#050811] rounded-xl p-5 border border-white/5 h-36">
                  <div className="relative flex items-center justify-center">
                    ...
                    <div className="absolute flex flex-col items-center">
                      <span className="font-mono text-xl font-black text-white leading-none">{completionPercentage}%</span>
                      <span className="text-[8px] font-black text-slate-500 uppercase tracking-wider mt-0.5">Done</span>
                    </div>
                  </div>
                </div>
